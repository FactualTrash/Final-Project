...
public class TitleScreen extends javax.swing.JFrame {
    ...
    private SecondScreen otherscreen;
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(928, 793));
        setPreferredSize(new java.awt.Dimension(928, 793));
        setResizable(false);
        ...
        getContentPane().add(btnStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 440, -1, -1));
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        if (otherscreen == null) {
            otherscreen = new SecondScreen(this);
        }
